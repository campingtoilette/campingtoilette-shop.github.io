        ...
        <div class="row g-5">
          <div class="col-lg-6 fadeInUp" style="min-height: 400px">
            <div class="position-relative h-100">
              <img class="img-fluid position-absolute w-100 h-100" src="/assets/images/campingtoiletten.png"
                :alt="config.seo.mainKeyword" style="object-fit: cover; object-position: center bottom" />
            </div>
          </div>
    ...
    <!-- <div class="container-xxl py-5" id="campingtoiletten">
      <div class="container">
        <div class="text-center fadeInUp">
          ...
          <div class="mb-5 h2">{{ config.seo.mainKeyword }}</div>
        </div>
        <div class="row g-4 justify-content-center">
          <div
