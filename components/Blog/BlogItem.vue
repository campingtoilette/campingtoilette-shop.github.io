    ...
    <div>
        <div class="card h-100" style="width: 18rem">
            ...
            <div class="card-body">
                ...
                <nuxt-link :target="article.isDownloadableFile ? '_blank' : false" :download="article.isDownloadableFile ? '' : false" :to="article.link" :title="article.title" class="btn btn-primary align-items-center d-block">
...
export default {
    ...
    head: {
        title: "News und Informationen rund ums Camping",
        meta: [
            {
                hid: "description",
                name: "description",
                content: "Hier findest du aktuelle News und Informationen zum Thema Camping und Outdoor. Weiterhin vergleichen wir Produkte und stellen dir die besten Modelle vor.",
            },
            {
                hid: "robots",
                name: "robots",
